...
const DEFAULT_TEMPLATES: ProtocolTemplate[] = [
  ...
  },
  {
    ...
    contentSelector: '[data-tag="post-content"], [data-testid="post-content"], div[class*="PostContent__Wrapper"], div[class*="PostContentWrapper"], div[class*="RichText-module"], .cm-bmFJIJ, .cm-bgKEqA, article, main', 
    removeSelectors: [
        '[data-tag="post-meta"]',
